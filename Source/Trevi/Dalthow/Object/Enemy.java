...
public class Enemy
{
	...
	public Enemy(double xPos, double yPos, String Name, Main Main, int Col, int Row)
	{
		SpriteGrabber Sprite = new SpriteGrabber(Main.getPlayerSpriteSheet());
		
		Enemy = Sprite.grabPlayerImage(Col, Row, 32, 32);
	}
	...
	{
		Graphics.drawImage(Enemy, Par1, Par2, 32, 32 , null);
	}
